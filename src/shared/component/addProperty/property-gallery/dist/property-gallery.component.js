...
exports.PropertyGalleryComponent = void 0;
var core_1 = require("@angular/core");
var PropertyGalleryComponent = /** @class */ (function () {
    function PropertyGalleryComponent(propertyService, router, userService, themeService) {
    ...
    PropertyGalleryComponent.prototype.ngOnInit = function () {
        var _this = this;
     ...
     */
    PropertyGalleryComponent.prototype.handleImageToBase64 = function (file) {
    ...
    PropertyGalleryComponent.prototype.handleAddPictures = function (event) {
     ...
     */
    PropertyGalleryComponent.prototype.handleAddProperty = function () {
        var _this = this;
        ...
        setTimeout(function () {
            _this.propertyService
                .handleAddProperty(_this.pictureUrls, _this.userData)
    ...
    PropertyGalleryComponent.prototype.showAndHideToast = function () {
        var _this = this;
        this.showToast = true;
        setTimeout(function () {
    ...
    PropertyGalleryComponent = __decorate([
        core_1.Component({
    ...
    return PropertyGalleryComponent;
}());
exports.PropertyGalleryComponent = PropertyGalleryComponent;
